      ...
      <div class="messages-header">
        ...
        <div class="header-right">
          <div class="header-actions">
            <Link :href="route('enseignant.messages.create')" class="btn btn-primary">
              ✏️ Nouveau message
            </Link>
            <Link :href="route('enseignant.messages.sent')" class="btn btn-secondary">
              📤 Messages envoyés
            </Link>
                ...
                <tr v-for="message in filteredMessages" :key="message.id" 
                  ...
                  <td class="actions-cell">
                    <div class="action-buttons">
                      <Link :href="route('enseignant.messages.show', message.id)" class="btn-action view">
                        👁️ Voir
                      </Link>
...
const markAllAsRead = () => {
  if (confirm('Marquer tous les messages comme lus ?')) {
    router.post(route('ensignant.messages.mark-all-read'), {}, {
      preserveScroll: true,
      onSuccess: () => {
        router.reload()
      }
...
const deleteMessage = (id) => {
  if (confirm('Voulez-vous vraiment supprimer ce message ?')) {
    router.delete(route('ensignant.messages.destroy', id), {
      preserveScroll: true,
      onSuccess: () => {
        router.reload()
      }
